...
public class ListOfMembers extends javax.swing.JFrame {
    ...
    public ListOfMembers() {
        ...
        try
        {
            ...
            while(rs.next())
            {
                model.addRow(new Object[]{rs.getString(1),rs.getString(2),rs.getString(9),rs.getString(5),rs.getString(3),rs.getString(4),rs.getString(6),rs.getString(8),rs.getString(7),rs.getString(10)});
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/list of members.jpg"))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Member ID", "Name", "Age", "Gender", "Mobile Number", "Email", "Address", "Aadhar Number", "Gym Time", "Amount"
            }
        ));
